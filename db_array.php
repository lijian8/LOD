...
//$tcmct = array("localhost", "root", "yutong", "tcmls1");

$dbs = array("tcmls" => $tcmls,  "spleen" => $spleen, "herb" => $herb, "formula" => $formula, "formula_dic" => $formula_dic, "cases" => $cases);
$db_labels = array("tcmls" => "TCMLS",  "spleen" => "证候库", "herb" => "中药库", "formula" => "方剂库", "formula_dic" => "方剂辞典",  "cases" => "医案库");
