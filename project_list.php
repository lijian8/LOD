            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $row[id]; ?>">
                            <?php echo $row[title]; ?>
                        </a>
                    </h4>
                </div>
                <div id="collapse<?php echo $row[id]; ?>" class="panel-collapse collapse">
                    <div class="panel-body">
                        <?php echo $row[desc]; ?>
                        <p align="right"><a class="btn btn-link" href="<?php echo $row[uri]; ?>"  target="_blank">查看详情 »</a></p>
                    </div>
                </div>
            </div>
            <?php
