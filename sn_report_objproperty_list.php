...
$query = "select property, count(*) as count from graph where value like '" . PREFIX . "%' group by property order by count desc";
...
<div class="container">
    ...
    <br>
    <?php
    $sn_subname = 'sn_report_objproperty_list';
    include_once ("sn_sub_header.php");
    ?>  
    <p class="lead"><?php echo $db_labels[$db_name]; ?>的语义关系（<?php echo count($values); ?>种）列表</p>
