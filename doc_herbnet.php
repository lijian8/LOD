    ...
    <div class="container">
        ...
        <div class="jumbotron">
            ...
            <a class="btn btn-lg btn-primary" href="docs/spleen.docx" role="button"><span class="glyphicon glyphicon-download"></span>&nbsp;下载技术报告</a></p>
                     ...
                     <p class="lead"><a href="<?php echo $_SERVER['PHP_SELF'] . '?example=syndrome'; ?>">中国方剂数据库</a></p>
                        <p>中国方剂数据库为文献型数据库，收录古今中药方剂。收录了来自《圣济总录》、《圣惠》、《普济方》、《外台》、《千金》、《医方类聚》、《辨证录》等710余种古籍及现代文献中的古今中药方剂84464首，分别介绍每一方剂的不同名称、处方来源、药物组成、功效、主治、用药禁忌、药理作用、制备方法等方面信息。</p>
